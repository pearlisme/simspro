...
(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('students',{
	        url:'/students',
	        templateUrl: viewsPrefix + 'students.html',
	        controller:'StudentListController'
	    }).state('viewShipwreck',{
	       url:'/students/:id/view',
	       templateUrl: viewsPrefix + 'student-view.html',
	       controller:'StudentViewController'
	    }).state('newStudent',{
	        url:'/students/new',
	        templateUrl: viewsPrefix + 'student-add.html',
	        controller:'StudentCreateController'
	    }).state('editStudent',{
	        url:'/students/:id/edit',
	        templateUrl: viewsPrefix + 'student-edit.html',
